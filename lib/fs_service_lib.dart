...
export 'package:fs_service_lib/domain/repo/firestore_order.dart';
  ...
  Future<void> init({
    ...
    db = FirestoreRepoImpl(
      documentMapper: DocumentMapper(
        ...
        pathUtils: pathUtils,
      )..init(metaPrefix: metaPrefix),
      firestoreApiProvider: FirestoreApiProviderImpl(
        cachingClient: cachingClient,
      ),
      firestorePathUtils:
          FirestorePathUtils()
            ..init(projectId: projectId, databaseId: databaseId),
      pathUtils: pathUtils,
    );

    await db.init(projectId: projectId, databaseId: databaseId);
  }
