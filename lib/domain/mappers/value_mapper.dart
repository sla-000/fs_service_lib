...
class ValueMapper {
  ...
  String _locationPrefix = kLocationPrefix;
  String _referencePrefix = kReferencePrefix;
  String _bytesPrefix = kBytesPrefix;
  String _datetimePrefix = kDatetimePrefix;
