...
void main() async {
  ...
  // $name: test-1000,
  // $createTime: 2025-06-29T11:39:30.294544Z, $updateTime: 2025-06-29T11:39:30.294544Z
  // }`

  var test2000Doc =
      await fsServiceLib.db.getDocument(documentPath: '/test/test-2000');
  stdout.writeln('test2000Doc=`$test2000Doc`'); // test2000Doc=`{
  // textField: value2, $name: test-2000,
  // $createTime: 2025-06-29T11:39:30.642846Z, $updateTime: 2025-06-29T11:39:30.642846Z
  // }`

  await fsServiceLib.db.updateDocument(
    documentPath: '/test/test-2000',
    json: {
      'doubleField': 9876.5432,
    },
  );
  ...
  test2000Doc =
      await fsServiceLib.db.getDocument(documentPath: '/test/test-2000');
  stdout.writeln('test2000Doc=`$test2000Doc`'); // test2000Doc=`{
  // doubleField: 9876.5432, $name: test-2000,
  // $createTime: 2025-06-29T11:39:30.642846Z, $updateTime: 2025-06-29T11:53:19.045956Z
  // }`
}
