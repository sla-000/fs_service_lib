...
void main() {
  ...
  group('ValueMapper tests - ', () {
    test('toJsonObject tests', () {
      ...
      expect(valueMapper.toJsonObject(Value(booleanValue: true)), equals(true));
      ...
      expect(
        valueMapper.toJsonObject(
          Value(
            geoPointValue: LatLng(latitude: _latitude, longitude: _longitude),
          ),
        ),
      ...
      expect(
        ...
        equals({'str1Key': 'str1Val', 'int1Key': 456334}),
      );
    ...
    test('fromJsonObject tests', () {
      ...
      value = valueMapper.fromJsonObject(
        '$_locationPrefix$_latitude/$_longitude',
      );
