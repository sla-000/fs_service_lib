...
void main() {
  ...
  group('DocumentMapper tests 1 - ', () {
    ...
    final createTimeUtc = DateTime.parse(createTime).toUtc().toIso8601String();
    final updateTimeUtc = DateTime.parse(updateTime).toUtc().toIso8601String();
    ...
    test('jsonToDocument tests', () async {
      var count = 0;
    ...
    test('jsonToCollection tests', () async {
      var count = 0;
    ...
    test('jsonToDocument tests', () async {
      ...
      Future<void> onParsed(
        ...
        switch (count++) {
          ...
          case 9:
            {
              expect(relativePath, equals('$colPath/cvbn/test4/cvbn/test4'));
              expect(documentId, equals('95il61U47MVonL027u3V'));
              expect(document.asMap, {
                'numberF': '1234.5432',
                'word': 'four',
    ...
    test('jsonToCollection tests', () async {
      ...
      Future<void> onParsed(
        ...
        switch (count++) {
          ...
          case 8:
            {
              expect(relativePath, equals('$docPath/test4/cvbn/test4'));
              expect(documentId, equals('95il61U47MVonL027u3V'));
              expect(document.asMap, {
                'geopoint': '34.3456/-23.432',
                'boolean': 'true',
          ...
          case 9:
            {
              expect(
                relativePath,
                equals('$docPath/test4/cvbn/test4/95il61U47MVonL027u3V/test5'),
              );
              expect(documentId, equals('DWtYaWaur4LeTHlnEAIG'));
              expect(document.asMap, {
                'test5': 'test5aaa',
